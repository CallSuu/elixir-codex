...
public class QuestDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<QuestTemplate> pool = List.of(
                ...
                QuestTemplate.builder().title("카페인 컷오프 지키기").description("오후 2시 이후 카페인 섭취 금지").dataSource(QuestDataSource.MANUAL).rewardMaterialName("천년 뿌리").build(),
                ...
                QuestTemplate.builder().title("스트레칭 10분 하기").description("오늘 하루 10분 이상 스트레칭하기").dataSource(QuestDataSource.MANUAL).rewardMaterialName("안정석").build(),
